...
class DpdWebPage {
    ...
    async getLabel() {
        ...
        await this.page.waitForSelector('#modHeader_repMobileBurgerNav_repBurgerNavLevel2_3_hplBurgerNav2Sub_1', {
            visible: true
        });
    ...
    async incomingParcels() {
        ...
        await this.page.waitForSelector('#modHeader_repMobileBurgerNav_repBurgerNavLevel2_3_hplBurgerNav2Sub_2', {
            visible: true
        });
    ...
    async invoices() {
        ...
        await this.page.waitForSelector('#modHeader_repMobileBurgerNav_repBurgerNavLevel2_3_hplBurgerNav2Sub_5', {
            visible: true
        });
        ...
        const data = await this.page.evaluate(() =>
            Array.from(document.querySelectorAll('td'), (td) => {
                if (!td.innerText) {
