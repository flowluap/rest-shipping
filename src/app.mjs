...
//import  dpdWeb  from "./controller/provider/dpd-web/webScraper/index.mjs";
...
app.use(function (req, res, next) {
    ...
    res.setHeader(
        ...
        'Origin, X-Requested-With, Content-Type, Accept, authorization, X-PINGOTHER, X-File-Name, Cache-Control,X-Explorer-Storage,X-Explorer-Path'
    );
